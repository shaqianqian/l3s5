...
readme:
  Nous avons fini les exercices 5,6 sur la support de tp. Les résultats des fichiers forkfork.c et race.c sont dans les fichiers forkfork.txt et race.txt. Nous avons aussi fait le makefile pour les compiler.
