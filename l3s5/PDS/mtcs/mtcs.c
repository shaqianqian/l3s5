...
/* Retourne une socket d'ecoute sur le port passé en argument
   (ce numéro de port peut etre modifie si il etait deja utilise) */
static int
...
create_cnct(int skfd)
{
    ...
    /* un thread fils pour gérer cetet connection */
