...
command(110,6,c,autosave,'Switch','Enable or disable automatic saving and restoring of the database','Enable or disable automatic saving and restoring of the database (on or off, resp.) . The option toggle toggles its state (from on to off and vice versa. If enabled, the complete database is automatically saved upon exiting and restored upon starting in the file des.sds').
