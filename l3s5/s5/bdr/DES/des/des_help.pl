...
list_builtins(B) :-
  ...
  (\+ \+ unary_operator(B,_,M) -> 
    write_log_list(['* Prefix Operators:',nl]),
    Found=true
   ;
    true),
  (unary_operator(B,_,M), 
   ...
   ; 
   true),
  (\+ \+ my_infix_operator(B,_,_,_,M,_,_) -> 
    write_log_list(['* Infix Operators:',nl]),
    Found=true
   ;
    true),
  (my_infix_operator(B,_,_,_,M,_,_),
  ...
  (function(B,_,M,arithmetic,_,_),
   ...
   ; 
   true),
  (\+ \+ function(B,_,M,string,_,_) ->
    write_log_list(['* String Functions:',nl]),
    Found=true
   ;
    true),
  (function(B,_,M,string,_,_),
   ...
   ; 
   true),
  (\+ \+ function(B,_,M,datetime,_,_) ->
    write_log_list(['* Date/Time Functions:',nl]),
    Found=true
   ;
    true),
  (function(B,_,M,datetime,_,_),
   ...
   ; 
   true),
  (\+ \+ function(B,_,M,aggregate,_,_) ->
    write_log_list(['* Aggregate Functions:',nl]),
    Found=true
   ;
    true),
  (function(B,_,M,aggregate,_,Ar),
   ...
   ; 
   true),
  (\+ \+ function(B,_,M,arithmetic_cte,_,_) ->
